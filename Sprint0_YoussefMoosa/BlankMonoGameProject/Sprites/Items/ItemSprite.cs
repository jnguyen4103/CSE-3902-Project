...
namespace Sprint03
{
    class ItemSprite : Sprite
    {
        ...
        public ItemSprite(Game1 game, String name, Texture2D texture, Vector2 spawn, SpriteBatch batch)
        {
            ...
            this.Batch = batch;
            this.Name = name;
            this.Size = game.Factory.ItemSprites[name].Item2;
            this.Position = spawn;
            this.Texture = texture;
            this.BaseSpeed = 0.5f;
            this.TotalFrames = game.Factory.ItemSprites[name].Item3;
            this.FPS = 4;
        ...
        public override void ChangeSpriteAnimation(string newSpriteName)
        {
            Name = newSpriteName;
            CurrentFrame = 0;
            Tuple<Rectangle, Vector2, int> NewInfo = Game.Factory.ItemSprites[newSpriteName];
