...
namespace Sprint02
{
    class ArrowEffect: IEffect
    {
        private Texture2D effectTexture;
        private Game1 monoProcess;
        private readonly SpriteBatch spriteBatch;

        public ArrowEffect(Texture2D texture, SpriteBatch batch, Game1 monoInstance)
        {
        ...
        public void createEffectSprite(Vector2 position, int xDir, int yDir)
        {
            ...
            monoProcess.EffectsList.Add(new ArrowSprite(effectTexture, spriteBatch, position, xDir, yDir));
